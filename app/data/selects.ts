...
export const selects: Select[] = [
  {
    ...
    overlayImages: [
      { src: img1_2, clearedSrc: clear1,  top: "5%", left: "17%", width: "30%", height: "39%", navigateTo: "/game/1" },
      { src: img2_2, clearedSrc: maturi1, top: "0%", left: "53%", width: "30%", height: "50%", navigateTo: "/game/2" },
    ],
  },
  {
    id: 2,
